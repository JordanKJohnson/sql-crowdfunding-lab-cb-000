...
"SELECT projects.title,SUM(pledges.amount) as raised FROM projects INNER JOIN pledges on projects.id = pledges.project_id HAVING raised > projects.funding_goal;"
end
